...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-swf8mvu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-swf8mvu.containers.anotherwebservice.com/
...
```
git clone git@github.com:jun10r4lm31d4/container-swf8mvu.git
cd container-swf8mvu
```
...
```
docker attach container-swf8mvu
```
